...
impl Builder {
    ...
    /// impl aws_sdk_glacier::config::auth::ResolveAuthScheme for CustomAuthSchemeResolver {
    ///     fn resolve_auth_scheme<'a>(
    ///         &'a self,
    ///         _params: &'a aws_sdk_glacier::config::auth::Params,
    ///         _cfg: &'a ConfigBag,
    ///         _runtime_components: &'a RuntimeComponents,
    ...
    /// # Default Behavior
    ///
    /// When no retry partition is explicitly set, the SDK automatically creates a default retry partition named `glacier`
    /// (or `glacier-<region>` if a region is configured).
    /// All Glacier clients without an explicit retry partition will share this default partition.
    ///
    /// # Notes
    ///
    ...
    /// ```no_run
    /// use aws_sdk_glacier::config::Config;
    /// use aws_sdk_glacier::config::retry::{RetryPartition, TokenBucket};
    ///
    ...
    /// ```no_run
    /// use aws_sdk_glacier::config::Config;
    /// use aws_sdk_glacier::config::retry::{ClientRateLimiter, RetryConfig, RetryPartition};
    ///
    ...
    /// #    fn meta(&self) -> &aws_sdk_glacier::error::ErrorMetadata { todo!() }
    /// # }
    ///
    ...
    pub fn build(mut self) -> Config {
        ...
        layer.store_put(::aws_types::SigningName::from_static("glacier"));
        layer
        ...
        Config {
            config: crate::config::Layer::from(layer.clone())
                .with_name("aws_sdk_glacier::config::Config")
                .freeze(),
            cloneable: layer,
...
impl ServiceRuntimePlugin {
    pub fn new(_service_config: crate::config::Config) -> Self {
        ...
        runtime_components.push_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
            crate::glacier_interceptors::GlacierApiVersionInterceptor::new("2012-06-01"),
        ));
    ...
    pub(crate) fn new(
        ...
        Self {
            config: ::aws_smithy_types::config_bag::Layer::from(layer)
                .with_name("aws_sdk_glacier::config::ConfigOverrideRuntimePlugin")
                .freeze(),
            components,
        }
    }
