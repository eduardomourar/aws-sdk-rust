...
/// Configuration for a aws_sdk_datazone service client.
///
...
impl Builder {
    ...
    /// use aws_sdk_datazone::config::Config;
    ...
    /// # fn example() {
    /// use std::time::Duration;
    /// use aws_sdk_datazone::config::{Builder, Config};
    /// use aws_smithy_runtime::client::http::hyper_014::HyperClientBuilder;
    ///
    ...
    /// }
    ///
    /// let mut builder = aws_sdk_datazone::Config::builder();
    ...
    /// impl aws_sdk_datazone::config::auth::ResolveAuthScheme for CustomAuthSchemeResolver {
    ///     fn resolve_auth_scheme<'a>(
    ///         &'a self,
    ///         _params: &'a aws_sdk_datazone::config::auth::Params,
    ///         _cfg: &'a ConfigBag,
    ///         _runtime_components: &'a RuntimeComponents,
    ...
    /// }
    ///
    /// let config = aws_sdk_datazone::Config::builder()
    ...
    ///     // ...
    ///     .build();
    /// let client = aws_sdk_datazone::Client::from_conf(config);
    /// ```
    ...
    /// ```no_run
    /// use aws_sdk_datazone::config::endpoint::{ResolveEndpoint, EndpointFuture, Params, Endpoint};
    /// #[derive(Debug)]
    ...
    /// let config = aws_sdk_datazone::Config::builder().endpoint_resolver(resolver).build();
    /// let client = aws_sdk_datazone::Client::from_conf(config);
    /// ```
    ...
    /// ```no_run
    /// use aws_sdk_datazone::config::Config;
    /// use aws_sdk_datazone::config::retry::RetryConfig;
    ///
    ...
    ///
    /// ```no_run
    /// use aws_sdk_datazone::config::{AsyncSleep, Config, SharedAsyncSleep, Sleep};
    ///
    /// #[derive(Debug)]
    ...
    ///
    /// ```no_run
    /// use aws_sdk_datazone::config::{AsyncSleep, Builder, Config, SharedAsyncSleep, Sleep};
    ///
    /// #[derive(Debug)]
    /// pub struct ForeverSleep;
    ///
    ...
    /// # use std::time::Duration;
    /// use aws_sdk_datazone::config::Config;
    /// use aws_sdk_datazone::config::timeout::TimeoutConfig;
    ///
    ...
    /// # Default Behavior
    ///
    /// When no retry partition is explicitly set, the SDK automatically creates a default retry partition named `datazone`
    /// (or `datazone-<region>` if a region is configured).
    /// All DataZone clients without an explicit retry partition will share this default partition.
    ///
    /// # Notes
    ///
    ...
    /// ```no_run
    /// use aws_sdk_datazone::config::Config;
    /// use aws_sdk_datazone::config::retry::{RetryPartition, TokenBucket};
    ///
    ...
    /// ```no_run
    /// use aws_sdk_datazone::config::Config;
    /// use aws_sdk_datazone::config::retry::{ClientRateLimiter, RetryConfig, RetryPartition};
    ///
    ...
    /// ```no_run
    /// use aws_sdk_datazone::config::IdentityCache;
    ///
    /// let config = aws_sdk_datazone::Config::builder()
    ...
    /// #    fn meta(&self) -> &aws_sdk_datazone::error::ErrorMetadata { todo!() }
    /// # }
    ///
    ...
    /// ```no_run
    /// use aws_sdk_datazone::config::BehaviorVersion;
    ///
    /// let config = aws_sdk_datazone::Config::builder()
    ...
    pub fn build(mut self) -> Config {
        ...
        layer.store_put(::aws_types::SigningName::from_static("datazone"));
        layer
        ...
        Config {
            config: crate::config::Layer::from(layer.clone())
                .with_name("aws_sdk_datazone::config::Config")
                .freeze(),
            cloneable: layer,
...
impl ServiceRuntimePlugin {
    pub fn new(_service_config: crate::config::Config) -> Self {
        let config = {
            let mut cfg = ::aws_smithy_types::config_bag::Layer::new("DataZone");
    ...
    pub(crate) fn new(
        ...
        Self {
            config: ::aws_smithy_types::config_bag::Layer::from(layer)
                .with_name("aws_sdk_datazone::config::ConfigOverrideRuntimePlugin")
                .freeze(),
            components,
        }
    }
        ...
        if input.get_origin("endpoint_url").is_client_config() {
            ...
            builder.set_endpoint_url(
                input
                    .service_config()
                    .and_then(|conf| {
                        conf.load_config(service_config_key("DataZone", "AWS_ENDPOINT_URL", "endpoint_url"))
...
pub(crate) fn base_client_runtime_plugins(mut config: crate::Config) -> ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugins {
    ...
    let default_retry_partition = "datazone";
