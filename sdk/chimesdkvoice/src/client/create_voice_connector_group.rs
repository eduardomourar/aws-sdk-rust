...
impl super::Client {
    ...
    ///   - [`call_distribution_type(CallDistributionType)`](crate::operation::create_voice_connector_group::builders::CreateVoiceConnectorGroupFluentBuilder::call_distribution_type) / [`set_call_distribution_type(Option<CallDistributionType>)`](crate::operation::create_voice_connector_group::builders::CreateVoiceConnectorGroupFluentBuilder::set_call_distribution_type):<br>required: **false**<br>(undocumented)<br>
