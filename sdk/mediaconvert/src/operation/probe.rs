...
/// Orchestration and serialization glue logic for `Probe`.
...
impl Probe {
    ...
    > {
        let map_err = |err: ::aws_smithy_runtime_api::client::result::SdkError<
            ...
            ::aws_smithy_runtime_api::client::orchestrator::HttpResponse,
        >| { err.map_service_error(|err| err.downcast::<crate::operation::probe::ProbeError>().expect("correct error type")) };
        let context = Self::orchestrate_with_stop_point(runtime_plugins, input, ::aws_smithy_runtime::client::orchestrator::StopPoint::None)
            .await
            .map_err(map_err)?;
        let output = context.finalize().map_err(map_err)?;
        ::std::result::Result::Ok(output.downcast::<crate::operation::probe::ProbeOutput>().expect("correct output type"))
    }
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("MediaConvert", "Probe", input, runtime_plugins, stop_point)
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for Probe {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        let mut cfg = ::aws_smithy_types::config_bag::Layer::new("Probe");

        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            ProbeRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            ProbeResponseDeserializer,
        ));
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::orchestrator::Metadata::new("Probe", "MediaConvert"));
    ...
    fn runtime_components(
        ...
        #[allow(unused_mut)]
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("Probe")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                ::aws_smithy_runtime::client::stalled_stream_protection::StalledStreamProtectionInterceptor::default(),
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                ProbeEndpointParamsInterceptor,
            ))
...
#[derive(Debug)]
struct ProbeResponseDeserializer;
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for ProbeResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            crate::protocol_serde::shape_probe::de_probe_http_error(status, headers, body)
        } else {
            crate::protocol_serde::shape_probe::de_probe_http_response(status, headers, body)
        };
        crate::protocol_serde::type_erase_result(parse_result)
    }
}
#[derive(Debug)]
struct ProbeRequestSerializer;
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for ProbeRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input.downcast::<crate::operation::probe::ProbeInput>().expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::probe::ProbeInput,
                output: &mut ::std::string::String,
            ) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
                use ::std::fmt::Write as _;
                ::std::write!(output, "/2017-08-29/probe").expect("formatting should succeed");
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_probe::ser_probe_input(&input)?);
...
#[derive(Debug)]
struct ProbeEndpointParamsInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for ProbeEndpointParamsInterceptor {
    ...
    fn read_before_execution(
        ...
        let _input = context.input().downcast_ref::<ProbeInput>().ok_or("failed to downcast to ProbeInput")?;
...
/// Error type for the `ProbeError` operation.
#[non_exhaustive]
...
pub enum ProbeError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-ProbeError) for what information is available for the error.")]
    Unhandled(crate::error::sealed_unhandled::Unhandled),
}
impl ProbeError {
    /// Creates the `ProbeError::Unhandled` variant from any error type.
    pub fn unhandled(
    ...
    /// Creates the `ProbeError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
    ...
    /// Returns `true` if the error kind is `ProbeError::BadRequestException`.
    pub fn is_bad_request_exception(&self) -> bool {
        matches!(self, Self::BadRequestException(_))
    }
    /// Returns `true` if the error kind is `ProbeError::ConflictException`.
    pub fn is_conflict_exception(&self) -> bool {
        matches!(self, Self::ConflictException(_))
    }
    /// Returns `true` if the error kind is `ProbeError::ForbiddenException`.
    pub fn is_forbidden_exception(&self) -> bool {
        matches!(self, Self::ForbiddenException(_))
    }
    /// Returns `true` if the error kind is `ProbeError::InternalServerErrorException`.
    pub fn is_internal_server_error_exception(&self) -> bool {
        matches!(self, Self::InternalServerErrorException(_))
    }
    /// Returns `true` if the error kind is `ProbeError::NotFoundException`.
    pub fn is_not_found_exception(&self) -> bool {
        matches!(self, Self::NotFoundException(_))
    }
    /// Returns `true` if the error kind is `ProbeError::ServiceQuotaExceededException`.
    pub fn is_service_quota_exceeded_exception(&self) -> bool {
        matches!(self, Self::ServiceQuotaExceededException(_))
    }
    /// Returns `true` if the error kind is `ProbeError::TooManyRequestsException`.
...
impl ::aws_smithy_types::retry::ProvideErrorKind for ProbeError {
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for ProbeError {
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for ProbeError {
...
impl ::aws_types::request_id::RequestId for crate::operation::probe::ProbeError {
