...
/// Configuration for a aws_sdk_medicalimaging service client.
///
...
impl Builder {
    ...
    /// use aws_sdk_medicalimaging::config::Config;
    ...
    /// # fn example() {
    /// use std::time::Duration;
    /// use aws_sdk_medicalimaging::config::{Builder, Config};
    /// use aws_smithy_runtime::client::http::hyper_014::HyperClientBuilder;
    ///
    ...
    /// }
    ///
    /// let mut builder = aws_sdk_medicalimaging::Config::builder();
    ...
    /// impl aws_sdk_medicalimaging::config::auth::ResolveAuthScheme for CustomAuthSchemeResolver {
    ///     fn resolve_auth_scheme<'a>(
    ///         &'a self,
    ///         _params: &'a aws_sdk_medicalimaging::config::auth::Params,
    ///         _cfg: &'a ConfigBag,
    ///         _runtime_components: &'a RuntimeComponents,
    ...
    /// }
    ///
    /// let config = aws_sdk_medicalimaging::Config::builder()
    ...
    ///     // ...
    ///     .build();
    /// let client = aws_sdk_medicalimaging::Client::from_conf(config);
    /// ```
    ...
    /// rules for `aws_sdk_medicalimaging`.
    ///
    ///
    ...
    /// ```no_run
    /// use aws_sdk_medicalimaging::config::endpoint::{ResolveEndpoint, EndpointFuture, Params, Endpoint};
    /// #[derive(Debug)]
    ...
    /// let config = aws_sdk_medicalimaging::Config::builder().endpoint_resolver(resolver).build();
    /// let client = aws_sdk_medicalimaging::Client::from_conf(config);
    /// ```
    ...
    /// ```no_run
    /// use aws_sdk_medicalimaging::config::Config;
    /// use aws_sdk_medicalimaging::config::retry::RetryConfig;
    ///
    ...
    ///
    /// ```no_run
    /// use aws_sdk_medicalimaging::config::{AsyncSleep, Config, SharedAsyncSleep, Sleep};
    ///
    /// #[derive(Debug)]
    ...
    ///
    /// ```no_run
    /// use aws_sdk_medicalimaging::config::{AsyncSleep, Builder, Config, SharedAsyncSleep, Sleep};
    ///
    /// #[derive(Debug)]
    /// pub struct ForeverSleep;
    ///
    ...
    /// # use std::time::Duration;
    /// use aws_sdk_medicalimaging::config::Config;
    /// use aws_sdk_medicalimaging::config::timeout::TimeoutConfig;
    ///
    ...
    /// # Default Behavior
    ///
    /// When no retry partition is explicitly set, the SDK automatically creates a default retry partition named `medicalimaging`
    /// (or `medicalimaging-<region>` if a region is configured).
    /// All Medical Imaging clients without an explicit retry partition will share this default partition.
    ///
    /// # Notes
    ///
    ...
    /// ```no_run
    /// use aws_sdk_medicalimaging::config::Config;
    /// use aws_sdk_medicalimaging::config::retry::{RetryPartition, TokenBucket};
    ///
    ...
    /// ```no_run
    /// use aws_sdk_medicalimaging::config::Config;
    /// use aws_sdk_medicalimaging::config::retry::{ClientRateLimiter, RetryConfig, RetryPartition};
    ///
    ...
    /// ```no_run
    /// use aws_sdk_medicalimaging::config::IdentityCache;
    ///
    /// let config = aws_sdk_medicalimaging::Config::builder()
    ...
    /// #    fn meta(&self) -> &aws_sdk_medicalimaging::error::ErrorMetadata { todo!() }
    /// # }
    ///
    ...
    /// ```no_run
    /// use aws_sdk_medicalimaging::config::BehaviorVersion;
    ///
    /// let config = aws_sdk_medicalimaging::Config::builder()
    ...
    pub fn build(mut self) -> Config {
        ...
        layer.store_put(::aws_types::SigningName::from_static("medical-imaging"));
        layer
        ...
        Config {
            config: crate::config::Layer::from(layer.clone())
                .with_name("aws_sdk_medicalimaging::config::Config")
                .freeze(),
            cloneable: layer,
...
impl ServiceRuntimePlugin {
    pub fn new(_service_config: crate::config::Config) -> Self {
        let config = {
            let mut cfg = ::aws_smithy_types::config_bag::Layer::new("AHIGatewayService");
    ...
    pub(crate) fn new(
        ...
        Self {
            config: ::aws_smithy_types::config_bag::Layer::from(layer)
                .with_name("aws_sdk_medicalimaging::config::ConfigOverrideRuntimePlugin")
                .freeze(),
            components,
        }
    }
        ...
        if input.get_origin("endpoint_url").is_client_config() {
            ...
            builder.set_endpoint_url(
                input
                    .service_config()
                    .and_then(|conf| {
                        conf.load_config(service_config_key("Medical Imaging", "AWS_ENDPOINT_URL", "endpoint_url"))
...
pub(crate) fn base_client_runtime_plugins(mut config: crate::Config) -> ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugins {
    ...
    let default_retry_partition = "medicalimaging";
    ...
    let scope = "aws-sdk-medicalimaging";
