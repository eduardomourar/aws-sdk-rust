...
pub(crate) fn reflens_list_available_phone_numbers_output_output_next_token(
    input: &crate::operation::list_available_phone_numbers::ListAvailablePhoneNumbersOutput,
) -> ::std::option::Option<&::std::string::String> {
    let input = match &input.next_token {
        ::std::option::Option::None => return ::std::option::Option::None,
        ::std::option::Option::Some(t) => t,
...
pub(crate) fn lens_list_available_phone_numbers_output_output_available_phone_numbers(
    input: crate::operation::list_available_phone_numbers::ListAvailablePhoneNumbersOutput,
) -> ::std::option::Option<::std::vec::Vec<::std::string::String>> {
    let input = input.available_phone_numbers;
    ::std::option::Option::Some(input)
}
