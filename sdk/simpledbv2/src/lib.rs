...
//! offered by Amazon SimpleDB v2. The return value of each of these methods is a "fluent builder",
...
/// Client for calling Amazon SimpleDB v2.
...
/// Configuration for Amazon SimpleDB v2.
pub mod config;
