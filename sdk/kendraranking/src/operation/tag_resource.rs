...
impl TagResource {
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("Kendra Ranking", "TagResource", input, runtime_plugins, stop_point)
    ...
    fn serialize_input(
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                ...
                ::std::write!(output, "/service/AWSKendraRerankingFrontendService/operation/TagResource").expect("formatting should succeed");
                ::std::result::Result::Ok(())
            }
