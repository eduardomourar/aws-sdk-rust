...
impl super::Client {
    ...
    ///   - [`destination(Destination)`](crate::operation::update_scraper::builders::UpdateScraperFluentBuilder::destination) / [`set_destination(Option<Destination>)`](crate::operation::update_scraper::builders::UpdateScraperFluentBuilder::set_destination):<br>required: **false**<br><p>The new destination where the scraper sends metrics. Valid destinations are Amazon Managed Service for Prometheus workspaces and CloudWatch datasets.</p><br>
