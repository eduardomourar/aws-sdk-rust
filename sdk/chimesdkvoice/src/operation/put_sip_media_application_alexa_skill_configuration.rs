...
impl PutSipMediaApplicationAlexaSkillConfiguration {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                                err.downcast::<crate::operation::put_sip_media_application_alexa_skill_configuration::PutSipMediaApplicationAlexaSkillConfigurationError>().expect("correct error type")
                            })
        };
        ...
        ::std::result::Result::Ok(output.downcast::<crate::operation::put_sip_media_application_alexa_skill_configuration::PutSipMediaApplicationAlexaSkillConfigurationOutput>().expect("correct output type"))
    }
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            "Chime SDK Voice.PutSipMediaApplicationAlexaSkillConfiguration",
            "rpc.service" = "Chime SDK Voice",
            "rpc.method" = "PutSipMediaApplicationAlexaSkillConfiguration",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for PutSipMediaApplicationAlexaSkillConfiguration {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        let mut cfg = ::aws_smithy_types::config_bag::Layer::new("PutSipMediaApplicationAlexaSkillConfiguration");

        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            PutSipMediaApplicationAlexaSkillConfigurationRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            PutSipMediaApplicationAlexaSkillConfigurationResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("PutSipMediaApplicationAlexaSkillConfiguration")
                .build()
    ...
    fn runtime_components(
        ...
        #[allow(unused_mut)]
        let mut rcb =
            ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("PutSipMediaApplicationAlexaSkillConfiguration")
                .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                    ::aws_smithy_runtime::client::stalled_stream_protection::StalledStreamProtectionInterceptor::default(),
                ))
                .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                    PutSipMediaApplicationAlexaSkillConfigurationEndpointParamsInterceptor,
                ))
...
#[derive(Debug)]
struct PutSipMediaApplicationAlexaSkillConfigurationResponseDeserializer;
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for PutSipMediaApplicationAlexaSkillConfigurationResponseDeserializer {
...
#[derive(Debug)]
struct PutSipMediaApplicationAlexaSkillConfigurationRequestSerializer;
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for PutSipMediaApplicationAlexaSkillConfigurationRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::put_sip_media_application_alexa_skill_configuration::PutSipMediaApplicationAlexaSkillConfigurationInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::put_sip_media_application_alexa_skill_configuration::PutSipMediaApplicationAlexaSkillConfigurationInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_put_sip_media_application_alexa_skill_configuration::ser_put_sip_media_application_alexa_skill_configuration_input(&input)?);
...
#[derive(Debug)]
struct PutSipMediaApplicationAlexaSkillConfigurationEndpointParamsInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for PutSipMediaApplicationAlexaSkillConfigurationEndpointParamsInterceptor {
    ...
    fn read_before_execution(
        ...
        let _input = context
            .input()
            .downcast_ref::<PutSipMediaApplicationAlexaSkillConfigurationInput>()
            .ok_or("failed to downcast to PutSipMediaApplicationAlexaSkillConfigurationInput")?;
...
pub enum PutSipMediaApplicationAlexaSkillConfigurationError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-PutSipMediaApplicationAlexaSkillConfigurationError) for what information is available for the error.")]
...
impl PutSipMediaApplicationAlexaSkillConfigurationError {
    ...
    /// Creates the `PutSipMediaApplicationAlexaSkillConfigurationError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for PutSipMediaApplicationAlexaSkillConfigurationError {
...
impl ::aws_types::request_id::RequestId
    for crate::operation::put_sip_media_application_alexa_skill_configuration::PutSipMediaApplicationAlexaSkillConfigurationError
{
