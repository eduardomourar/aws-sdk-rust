...
impl super::Client {
    ...
    ///   - [`session_policy(Option<String>)`](crate::operation::get_run::GetRunOutput::session_policy): Inline policy json for scoping down permissions via a session policy on the IAM role.
