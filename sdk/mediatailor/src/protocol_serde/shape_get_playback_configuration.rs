...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::get_playback_configuration::GetPlaybackConfigurationError::unhandled)?;
    generic_builder = ::aws_types::request_id::apply_request_id(generic_builder, _response_headers);
    let generic = generic_builder.build();
    Err(crate::operation::get_playback_configuration::GetPlaybackConfigurationError::generic(
        generic,
    ))
}
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_get_playback_configuration::de_get_playback_configuration(_response_body, output)
            .map_err(crate::operation::get_playback_configuration::GetPlaybackConfigurationError::unhandled)?;
