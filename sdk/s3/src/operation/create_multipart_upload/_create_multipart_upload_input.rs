...
impl ::std::fmt::Debug for CreateMultipartUploadInput {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        ...
        formatter.field("object_lock_event_hold_duration_days", &self.object_lock_event_hold_duration_days);
        formatter.field("object_lock_event_hold_duration_years", &self.object_lock_event_hold_duration_years);
...
impl CreateMultipartUploadInputBuilder {
    ...
    /// <p>This functionality is not supported for directory buckets.</p>
    /// </note>
    pub fn set_object_lock_event_hold(mut self, input: ::std::option::Option<crate::types::ObjectLockEventHold>) -> Self {
