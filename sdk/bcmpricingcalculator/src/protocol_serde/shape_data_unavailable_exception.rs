...
pub(crate) fn de_data_unavailable_exception_cbor_err(
    value: &[u8],
    mut builder: crate::types::error::builders::DataUnavailableExceptionBuilder,
) -> ::std::result::Result<crate::types::error::builders::DataUnavailableExceptionBuilder, ::aws_smithy_cbor::decode::DeserializeError> {
