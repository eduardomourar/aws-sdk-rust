                ...
                Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => {
                    ...
                    variant = match key.as_ref() {
                        "Drop" => Some(crate::types::RuleAction::Drop(
                            crate::protocol_serde::shape_drop_action::de_drop_action(tokens, _value, depth + 1)?
                        ...
                        "Relay" => Some(crate::types::RuleAction::Relay(
                            crate::protocol_serde::shape_relay_action::de_relay_action(tokens, _value, depth + 1)?
                        ...
                        "Archive" => Some(crate::types::RuleAction::Archive(
                            crate::protocol_serde::shape_archive_action::de_archive_action(tokens, _value, depth + 1)?.ok_or_else(|| {
                        ...
                        "WriteToS3" => Some(crate::types::RuleAction::WriteToS3(
                            crate::protocol_serde::shape_s3_action::de_s3_action(tokens, _value, depth + 1)?.ok_or_else(|| {
                        ...
                        "Send" => Some(crate::types::RuleAction::Send(
                            crate::protocol_serde::shape_send_action::de_send_action(tokens, _value, depth + 1)?
                        ...
                        "AddHeader" => Some(crate::types::RuleAction::AddHeader(
                            crate::protocol_serde::shape_add_header_action::de_add_header_action(tokens, _value, depth + 1)?.ok_or_else(|| {
                        ...
                        "ReplaceRecipient" => Some(crate::types::RuleAction::ReplaceRecipient(
                            crate::protocol_serde::shape_replace_recipient_action::de_replace_recipient_action(tokens, _value, depth + 1)?
                                .ok_or_else(|| {
                        ...
                        "DeliverToMailbox" => Some(crate::types::RuleAction::DeliverToMailbox(
                            crate::protocol_serde::shape_deliver_to_mailbox_action::de_deliver_to_mailbox_action(tokens, _value, depth + 1)?
                                .ok_or_else(|| {
                        ...
                        "DeliverToQBusiness" => Some(crate::types::RuleAction::DeliverToQBusiness(
                            crate::protocol_serde::shape_deliver_to_q_business_action::de_deliver_to_q_business_action(tokens, _value, depth + 1)?
                                .ok_or_else(|| {
                        ...
                        "PublishToSns" => Some(crate::types::RuleAction::PublishToSns(
                            crate::protocol_serde::shape_sns_action::de_sns_action(tokens, _value, depth + 1)?.ok_or_else(|| {
                        ...
                        "Bounce" => Some(crate::types::RuleAction::Bounce(
                            crate::protocol_serde::shape_bounce_action::de_bounce_action(tokens, _value, depth + 1)?.ok_or_else(|| {
                        ...
                        "InvokeLambda" => Some(crate::types::RuleAction::InvokeLambda(
                            crate::protocol_serde::shape_invoke_lambda_action::de_invoke_lambda_action(tokens, _value, depth + 1)?.ok_or_else(
