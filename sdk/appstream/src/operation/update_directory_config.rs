...
impl UpdateDirectoryConfig {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::update_directory_config::UpdateDirectoryConfigError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::update_directory_config::UpdateDirectoryConfigOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("AppStream", "UpdateDirectoryConfig", input, runtime_plugins, stop_point)
            // Create a parent span for the entire operation. Includes a random, internal-only,
            // seven-digit ID for the operation orchestration so that it can be correlated in the logs.
            .instrument(::tracing::debug_span!(
                "AppStream.UpdateDirectoryConfig",
                "rpc.service" = "AppStream",
                "rpc.method" = "UpdateDirectoryConfig",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for UpdateDirectoryConfig {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        let mut cfg = ::aws_smithy_types::config_bag::Layer::new("UpdateDirectoryConfig");

        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            UpdateDirectoryConfigRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            UpdateDirectoryConfigResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("UpdateDirectoryConfig")
                .build()
    ...
    fn runtime_components(
        ...
        #[allow(unused_mut)]
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("UpdateDirectoryConfig")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                ::aws_smithy_runtime::client::stalled_stream_protection::StalledStreamProtectionInterceptor::default(),
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                UpdateDirectoryConfigEndpointParamsInterceptor,
            ))
...
#[derive(Debug)]
struct UpdateDirectoryConfigResponseDeserializer;
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for UpdateDirectoryConfigResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            ...
            crate::protocol_serde::shape_update_directory_config::de_update_directory_config_http_response(status, headers, body)
        };
        crate::protocol_serde::type_erase_result(parse_result)
    }
}
#[derive(Debug)]
struct UpdateDirectoryConfigRequestSerializer;
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for UpdateDirectoryConfigRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::update_directory_config::UpdateDirectoryConfigInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::update_directory_config::UpdateDirectoryConfigInput,
                output: &mut ::std::string::String,
            ) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
                use ::std::fmt::Write as _;
                ::std::write!(output, "/service/PhotonAdminProxyService/operation/UpdateDirectoryConfig").expect("formatting should succeed");
                ::std::result::Result::Ok(())
            }
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_update_directory_config::ser_update_directory_config_input(
            &input,
        )?);
...
#[derive(Debug)]
struct UpdateDirectoryConfigEndpointParamsInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for UpdateDirectoryConfigEndpointParamsInterceptor {
    ...
    fn read_before_execution(
        ...
        let _input = context
            .input()
            .downcast_ref::<UpdateDirectoryConfigInput>()
            .ok_or("failed to downcast to UpdateDirectoryConfigInput")?;
...
pub enum UpdateDirectoryConfigError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-UpdateDirectoryConfigError) for what information is available for the error.")]
...
impl UpdateDirectoryConfigError {
    ...
    /// Creates the `UpdateDirectoryConfigError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for UpdateDirectoryConfigError {
...
impl ::aws_types::request_id::RequestId for crate::operation::update_directory_config::UpdateDirectoryConfigError {
