...
pub fn de_delete_space_http_error(
    ...
    Err(match error_code {
        ...
        "InternalFailureException" => crate::operation::delete_space::DeleteSpaceError::InternalFailureException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "InvalidParameterValueException" => crate::operation::delete_space::DeleteSpaceError::InvalidParameterValueException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
