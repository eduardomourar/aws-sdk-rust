            ...
            crate::operation::disassociate_app_block_builder_app_block::DisassociateAppBlockBuilderAppBlockError::InvalidParameterCombinationException(
                {
                    ...
                    let mut tmp = {
                        ...
                        output = crate::protocol_serde::shape_invalid_parameter_combination_exception::de_invalid_parameter_combination_exception_cbor_err(_response_body, output).map_err(crate::operation::disassociate_app_block_builder_app_block::DisassociateAppBlockBuilderAppBlockError::unhandled)?;
                        let output = output.meta(generic);
                        output.build()
                    };
                    if tmp.message.is_none() {
...
pub fn ser_disassociate_app_block_builder_app_block_input(
    ...
    let mut encoder = ::aws_smithy_cbor::Encoder::new(Vec::new());
    {
        ...
        crate::protocol_serde::shape_disassociate_app_block_builder_app_block_input::ser_disassociate_app_block_builder_app_block_input_input(
            encoder, input,
        )?;
    }
