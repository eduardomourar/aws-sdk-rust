...
pub fn ser_aws_security_finding_filters(
    ...
    if let Some(var_405) = &input.aws_account_name {
        let mut array_406 = object.key("AwsAccountName").start_array();
        for item_407 in var_405 {
            {
                #[allow(unused_mut)]
                let mut object_408 = array_406.value().start_object();
                crate::protocol_serde::shape_string_filter::ser_string_filter(&mut object_408, item_407)?;
                object_408.finish();
            }
        }
        array_406.finish();
    }
    if let Some(var_409) = &input.resource_application_name {
        let mut array_410 = object.key("ResourceApplicationName").start_array();
        for item_411 in var_409 {
            {
                #[allow(unused_mut)]
                let mut object_412 = array_410.value().start_object();
                crate::protocol_serde::shape_string_filter::ser_string_filter(&mut object_412, item_411)?;
                object_412.finish();
            }
        }
        array_410.finish();
    }
    if let Some(var_413) = &input.resource_application_arn {
        let mut array_414 = object.key("ResourceApplicationArn").start_array();
        for item_415 in var_413 {
            {
                #[allow(unused_mut)]
                let mut object_416 = array_414.value().start_object();
                crate::protocol_serde::shape_string_filter::ser_string_filter(&mut object_416, item_415)?;
                object_416.finish();
            }
        }
        array_414.finish();
                ...
                match tokens.next().transpose()? {
                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => {
                        match key.to_unescaped()?.as_ref() {
                            ...
                            "Region" => {
                                builder = builder.set_region(crate::protocol_serde::shape_string_filter_list::de_string_filter_list(
                                    tokens,
                                    _value,
                                    depth + 1,
                                )?);
                            ...
                            "SeverityProduct" => {
                                builder = builder.set_severity_product(crate::protocol_serde::shape_number_filter_list::de_number_filter_list(
                                    tokens,
                                    _value,
                                    depth + 1,
                                )?);
                            ...
                            "SeverityNormalized" => {
                                builder = builder.set_severity_normalized(crate::protocol_serde::shape_number_filter_list::de_number_filter_list(
                                    tokens,
                                    _value,
                                    depth + 1,
                                )?);
                            ...
                            "RecommendationText" => {
                                builder = builder.set_recommendation_text(crate::protocol_serde::shape_string_filter_list::de_string_filter_list(
                                    tokens,
                                    _value,
                                    depth + 1,
                                )?);
                            ...
                            "ProductFields" => {
                                builder = builder.set_product_fields(crate::protocol_serde::shape_map_filter_list::de_map_filter_list(
                                    tokens,
                                    _value,
                                    depth + 1,
                                )?);
                            ...
                            "MalwareName" => {
                                builder = builder.set_malware_name(crate::protocol_serde::shape_string_filter_list::de_string_filter_list(
                                    tokens,
                                    _value,
                                    depth + 1,
                                )?);
                            ...
                            "MalwareType" => {
                                builder = builder.set_malware_type(crate::protocol_serde::shape_string_filter_list::de_string_filter_list(
                                    tokens,
                                    _value,
                                    depth + 1,
                                )?);
                            ...
                            "MalwarePath" => {
                                builder = builder.set_malware_path(crate::protocol_serde::shape_string_filter_list::de_string_filter_list(
                                    tokens,
                                    _value,
                                    depth + 1,
                                )?);
                            ...
                            "MalwareState" => {
                                builder = builder.set_malware_state(crate::protocol_serde::shape_string_filter_list::de_string_filter_list(
                                    tokens,
                                    _value,
                                    depth + 1,
                                )?);
                            ...
                            "NetworkDirection" => {
                                builder = builder.set_network_direction(crate::protocol_serde::shape_string_filter_list::de_string_filter_list(
                                    tokens,
                                    _value,
                                    depth + 1,
                                )?);
                            ...
                            "NetworkSourceIpV4" => {
                                builder = builder.set_network_source_ipv4(crate::protocol_serde::shape_ip_filter_list::de_ip_filter_list(
                                    tokens,
                                    _value,
                                    depth + 1,
                                )?);
                            ...
                            "NetworkSourceIpV6" => {
                                builder = builder.set_network_source_ipv6(crate::protocol_serde::shape_ip_filter_list::de_ip_filter_list(
                                    tokens,
                                    _value,
                                    depth + 1,
                                )?);
                            ...
                            "NetworkSourcePort" => {
                                builder = builder.set_network_source_port(crate::protocol_serde::shape_number_filter_list::de_number_filter_list(
                                    tokens,
                                    _value,
                                    depth + 1,
                                )?);
                            ...
                            "NetworkSourceDomain" => {
                                builder = builder.set_network_source_domain(crate::protocol_serde::shape_string_filter_list::de_string_filter_list(
                                    tokens,
                                    _value,
                                    depth + 1,
                                )?);
                            ...
                            "NetworkSourceMac" => {
                                builder = builder.set_network_source_mac(crate::protocol_serde::shape_string_filter_list::de_string_filter_list(
                                    tokens,
                                    _value,
                                    depth + 1,
                                )?);
                            ...
                            "NetworkDestinationIpV4" => {
                                builder = builder.set_network_destination_ipv4(crate::protocol_serde::shape_ip_filter_list::de_ip_filter_list(
                                    tokens,
                                    _value,
                                    depth + 1,
                                )?);
                            ...
                            "NetworkDestinationIpV6" => {
                                builder = builder.set_network_destination_ipv6(crate::protocol_serde::shape_ip_filter_list::de_ip_filter_list(
                                    tokens,
                                    _value,
                                    depth + 1,
                                )?);
                            ...
                            "ProcessName" => {
                                builder = builder.set_process_name(crate::protocol_serde::shape_string_filter_list::de_string_filter_list(
                                    tokens,
                                    _value,
                                    depth + 1,
                                )?);
                            ...
                            "ProcessPath" => {
                                builder = builder.set_process_path(crate::protocol_serde::shape_string_filter_list::de_string_filter_list(
                                    tokens,
                                    _value,
                                    depth + 1,
                                )?);
                            ...
                            "ProcessPid" => {
                                builder = builder.set_process_pid(crate::protocol_serde::shape_number_filter_list::de_number_filter_list(
                                    tokens,
                                    _value,
                                    depth + 1,
                                )?);
                            ...
                            "ProcessParentPid" => {
                                builder = builder.set_process_parent_pid(crate::protocol_serde::shape_number_filter_list::de_number_filter_list(
                                    tokens,
                                    _value,
                                    depth + 1,
                                )?);
                            ...
                            "ProcessLaunchedAt" => {
                                builder = builder.set_process_launched_at(crate::protocol_serde::shape_date_filter_list::de_date_filter_list(
                                    tokens,
                                    _value,
                                    depth + 1,
                                )?);
                            ...
                            "ProcessTerminatedAt" => {
                                builder = builder.set_process_terminated_at(crate::protocol_serde::shape_date_filter_list::de_date_filter_list(
                                    tokens,
                                    _value,
                                    depth + 1,
                                )?);
                            ...
                            "ResourceAwsEc2InstanceIpV4Addresses" => {
                                builder = builder.set_resource_aws_ec2_instance_ipv4_addresses(
                                    crate::protocol_serde::shape_ip_filter_list::de_ip_filter_list(tokens, _value, depth + 1)?,
                                );
                            }
                            ...
                            "WorkflowState" => {
                                builder = builder.set_workflow_state(crate::protocol_serde::shape_string_filter_list::de_string_filter_list(
                                    tokens,
                                    _value,
                                    depth + 1,
                                )?);
                            ...
                            "Keyword" => {
                                builder = builder.set_keyword(crate::protocol_serde::shape_keyword_filter_list::de_keyword_filter_list(
                                    tokens,
                                    _value,
                                    depth + 1,
                                )?);
                            ...
                            "Sample" => {
                                builder = builder.set_sample(crate::protocol_serde::shape_boolean_filter_list::de_boolean_filter_list(
                                    tokens,
                                    _value,
                                    depth + 1,
                                )?);
                            ...
                            "VulnerabilitiesFixAvailable" => {
                                builder = builder.set_vulnerabilities_fix_available(
                                    crate::protocol_serde::shape_string_filter_list::de_string_filter_list(tokens, _value, depth + 1)?,
                                );
                            }
