                    ...
                    Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                        ...
                        "AlternateDataSourceParameters" => {
                            builder = builder.set_alternate_data_source_parameters(
                                crate::protocol_serde::shape_data_source_parameters_list::de_data_source_parameters_list(tokens, _value, depth + 1)?,
                            );
                        }
                        ...
                        "ErrorInfo" => {
                            builder = builder.set_error_info(crate::protocol_serde::shape_data_source_error_info::de_data_source_error_info(
                                tokens,
                                _value,
                                depth + 1,
                            )?);
