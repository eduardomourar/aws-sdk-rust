...
impl super::Client {
    ...
    ///   - [`filesystem_configurations(Option<Vec::<ToolsFileSystemConfiguration>>)`](crate::operation::get_browser_session::GetBrowserSessionOutput::filesystem_configurations): <p>The file system configurations for the browser session. Each entry describes an access point and its mount path.</p>
