...
pub fn ser_suggest_input_input(
    ...
    if let Some(var_7) = &input.filter {
        ...
        crate::protocol_serde::shape_suggest_filter::ser_suggest_filter(&mut object_8, var_7)?;
        object_8.finish();
    }
    ...
    if let Some(var_11) = &input.max_query_refinements {
        object.key("MaxQueryRefinements").number(
            #[allow(clippy::useless_conversion)]
