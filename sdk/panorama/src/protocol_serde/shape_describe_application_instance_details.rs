            ...
            Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => match key.to_unescaped()?.as_ref() {
                ...
                "ManifestOverridesPayload" => {
                    builder = builder.set_manifest_overrides_payload(
                        crate::protocol_serde::shape_manifest_overrides_payload::de_manifest_overrides_payload(tokens, _value, depth + 1)?,
                    );
                }
                "ManifestPayload" => {
                    builder = builder.set_manifest_payload(crate::protocol_serde::shape_manifest_payload::de_manifest_payload(
                        tokens,
                        _value,
                        depth + 1,
                    )?);
