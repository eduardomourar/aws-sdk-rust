...
/// Configuration for a aws_sdk_licensemanagerusersubscriptions service client.
///
...
impl Builder {
    ...
    /// impl aws_sdk_licensemanagerusersubscriptions::config::auth::ResolveAuthScheme for CustomAuthSchemeResolver {
    ///     fn resolve_auth_scheme<'a>(
    ///         &'a self,
    ///         _params: &'a aws_sdk_licensemanagerusersubscriptions::config::auth::Params,
    ///         _cfg: &'a ConfigBag,
    ///         _runtime_components: &'a RuntimeComponents,
    ...
    /// ```no_run
    /// use aws_sdk_licensemanagerusersubscriptions::config::endpoint::{ResolveEndpoint, EndpointFuture, Params, Endpoint};
    /// #[derive(Debug)]
    ...
    /// let config = aws_sdk_licensemanagerusersubscriptions::Config::builder().endpoint_resolver(resolver).build();
    /// let client = aws_sdk_licensemanagerusersubscriptions::Client::from_conf(config);
    /// ```
    ...
    /// # Default Behavior
    ///
    /// When no retry partition is explicitly set, the SDK automatically creates a default retry partition named `licensemanagerusersubscriptions`
    /// (or `licensemanagerusersubscriptions-<region>` if a region is configured).
    /// All License Manager User Subscriptions clients without an explicit retry partition will share this default partition.
    ///
    /// # Notes
    ///
    ...
    /// ```no_run
    /// use aws_sdk_licensemanagerusersubscriptions::config::Config;
    /// use aws_sdk_licensemanagerusersubscriptions::config::retry::{RetryPartition, TokenBucket};
    ///
    ...
    /// ```no_run
    /// use aws_sdk_licensemanagerusersubscriptions::config::Config;
    /// use aws_sdk_licensemanagerusersubscriptions::config::retry::{ClientRateLimiter, RetryConfig, RetryPartition};
    ///
    ...
    /// ```no_run
    /// use aws_sdk_licensemanagerusersubscriptions::config::IdentityCache;
    ///
    /// let config = aws_sdk_licensemanagerusersubscriptions::Config::builder()
    ...
    /// #    fn meta(&self) -> &aws_sdk_licensemanagerusersubscriptions::error::ErrorMetadata { todo!() }
    /// # }
    ///
    ...
    /// ```no_run
    /// use aws_sdk_licensemanagerusersubscriptions::config::BehaviorVersion;
    ///
    /// let config = aws_sdk_licensemanagerusersubscriptions::Config::builder()
    ...
    pub fn build(mut self) -> Config {
        ...
        layer.store_put(::aws_types::SigningName::from_static("license-manager-user-subscriptions"));
        layer
        ...
        Config {
            config: crate::config::Layer::from(layer.clone())
                .with_name("aws_sdk_licensemanagerusersubscriptions::config::Config")
                .freeze(),
            cloneable: layer,
...
impl ServiceRuntimePlugin {
    pub fn new(_service_config: crate::config::Config) -> Self {
        let config = {
            let mut cfg = ::aws_smithy_types::config_bag::Layer::new("LicenseManagerUserSubscriptions");
    ...
    pub(crate) fn new(
        ...
        Self {
            config: ::aws_smithy_types::config_bag::Layer::from(layer)
                .with_name("aws_sdk_licensemanagerusersubscriptions::config::ConfigOverrideRuntimePlugin")
                .freeze(),
            components,
        }
    }
...
pub(crate) fn base_client_runtime_plugins(mut config: crate::Config) -> ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugins {
    ...
    let default_retry_partition = "licensemanagerusersubscriptions";
    ...
    let scope = "aws-sdk-licensemanagerusersubscriptions";
