...
pub(crate) mod shape_get_estimated_carbon_emissions;
...
pub(crate) mod shape_get_estimated_carbon_emissions_dimension_values_input;
...
pub(crate) mod shape_granularity_configuration;

pub(crate) mod shape_time_period;

pub(crate) mod shape_dimension_entry;
