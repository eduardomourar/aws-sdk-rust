...
pub fn ser_list_bill_estimate_commitments_input(
    ...
    let mut encoder = ::aws_smithy_cbor::Encoder::new(Vec::new());
    {
        ...
        crate::protocol_serde::shape_list_bill_estimate_commitments_input::ser_list_bill_estimate_commitments_input_input(encoder, input)?;
    }
        ...
        builder = match decoder.str()?.as_ref() {
            "items" => ::aws_smithy_cbor::decode::set_optional(builder, decoder, |builder, decoder| {
                Ok(builder.set_items(Some(
                    crate::protocol_serde::shape_bill_estimate_commitment_summaries::de_bill_estimate_commitment_summaries(decoder, depth + 1)?,
                )))
            })?,
            "nextToken" => {
