...
impl UpdateFleet {
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("AppStream", "UpdateFleet", input, runtime_plugins, stop_point)
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for UpdateFleet {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        ...
        cfg.store_put(::aws_smithy_runtime_api::client::orchestrator::Metadata::new("UpdateFleet", "AppStream"));
    ...
    fn serialize_input(
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                ...
                ::std::write!(output, "/service/PhotonAdminProxyService/operation/UpdateFleet").expect("formatting should succeed");
                ::std::result::Result::Ok(())
            }
