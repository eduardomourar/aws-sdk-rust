...
impl ::std::convert::From<&str> for Dimension {
    fn from(s: &str) -> Self {
        match s {
            ...
            "USAGE_ACCOUNT_ID" => Dimension::UsageAccountId,
...
impl Dimension {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            ...
            Dimension::UsageAccountId => "USAGE_ACCOUNT_ID",
            Dimension::Unknown(value) => value.as_str(),
        }
    }
    /// Returns all the `&str` representations of the enum members.
    pub const fn values() -> &'static [&'static str] {
        &["REGION", "SERVICE", "USAGE_ACCOUNT_ID"]
    }
}
...
impl ::std::fmt::Display for Dimension {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            ...
            Dimension::UsageAccountId => write!(f, "USAGE_ACCOUNT_ID"),
