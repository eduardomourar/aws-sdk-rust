...
pub(crate) fn de_operation_not_permitted_exception_cbor_err(
    value: &[u8],
    mut builder: crate::types::error::builders::OperationNotPermittedExceptionBuilder,
) -> ::std::result::Result<crate::types::error::builders::OperationNotPermittedExceptionBuilder, ::aws_smithy_cbor::decode::DeserializeError> {
