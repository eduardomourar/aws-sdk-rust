...
pub fn de_describe_user_stack_associations_http_error(
...
> {
    ...
    let mut generic_builder = crate::cbor_errors::parse_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::describe_user_stack_associations::DescribeUserStackAssociationsError::unhandled)?;
    ...
    Err(match error_code {
        "InvalidParameterCombinationException" => {
            crate::operation::describe_user_stack_associations::DescribeUserStackAssociationsError::InvalidParameterCombinationException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "OperationNotPermittedException" => {
            crate::operation::describe_user_stack_associations::DescribeUserStackAssociationsError::OperationNotPermittedException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_describe_user_stack_associations_http_response(
    _response_status: u16,
    _response_headers: &::aws_smithy_runtime_api::http::Headers,
    _response_body: &[u8],
) -> std::result::Result<
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_describe_user_stack_associations::de_describe_user_stack_associations(_response_body, output)
            .map_err(crate::operation::describe_user_stack_associations::DescribeUserStackAssociationsError::unhandled)?;
...
pub fn ser_describe_user_stack_associations_input(
    ...
    let mut encoder = ::aws_smithy_cbor::Encoder::new(Vec::new());
    {
        ...
        crate::protocol_serde::shape_describe_user_stack_associations_input::ser_describe_user_stack_associations_input_input(encoder, input)?;
    }
...
> {
    ...
    > {
        builder = match decoder.str()?.as_ref() {
            "UserStackAssociations" => ::aws_smithy_cbor::decode::set_optional(builder, decoder, |builder, decoder| {
                Ok(builder.set_user_stack_associations(Some(
                    crate::protocol_serde::shape_user_stack_association_list::de_user_stack_association_list(decoder, depth + 1)?,
                )))
            })?,
            "NextToken" => {
