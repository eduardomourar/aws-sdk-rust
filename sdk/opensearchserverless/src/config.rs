...
/// Configuration for a aws_sdk_opensearchserverless service client.
///
...
impl Builder {
    ...
    /// impl aws_sdk_opensearchserverless::config::auth::ResolveAuthScheme for CustomAuthSchemeResolver {
    ///     fn resolve_auth_scheme<'a>(
    ///         &'a self,
    ///         _params: &'a aws_sdk_opensearchserverless::config::auth::Params,
    ///         _cfg: &'a ConfigBag,
    ///         _runtime_components: &'a RuntimeComponents,
    ...
    /// ```no_run
    /// use aws_sdk_opensearchserverless::config::endpoint::{ResolveEndpoint, EndpointFuture, Params, Endpoint};
    /// #[derive(Debug)]
    ...
    /// let config = aws_sdk_opensearchserverless::Config::builder().endpoint_resolver(resolver).build();
    /// let client = aws_sdk_opensearchserverless::Client::from_conf(config);
    /// ```
    ...
    /// # Default Behavior
    ///
    /// When no retry partition is explicitly set, the SDK automatically creates a default retry partition named `opensearchserverless`
    /// (or `opensearchserverless-<region>` if a region is configured).
    /// All OpenSearchServerless clients without an explicit retry partition will share this default partition.
    ///
    /// # Notes
    ///
    ...
    /// ```no_run
    /// use aws_sdk_opensearchserverless::config::Config;
    /// use aws_sdk_opensearchserverless::config::retry::{RetryPartition, TokenBucket};
    ///
    ...
    /// ```no_run
    /// use aws_sdk_opensearchserverless::config::Config;
    /// use aws_sdk_opensearchserverless::config::retry::{ClientRateLimiter, RetryConfig, RetryPartition};
    ///
    ...
    /// #    fn meta(&self) -> &aws_sdk_opensearchserverless::error::ErrorMetadata { todo!() }
    /// # }
    ///
    ...
    pub fn build(mut self) -> Config {
        ...
        layer.store_put(::aws_types::SigningName::from_static("aoss"));
        layer
...
impl ServiceRuntimePlugin {
    pub fn new(_service_config: crate::config::Config) -> Self {
        let config = {
            let mut cfg = ::aws_smithy_types::config_bag::Layer::new("OpenSearchServerless");
    ...
    pub(crate) fn new(
        ...
        Self {
            config: ::aws_smithy_types::config_bag::Layer::from(layer)
                .with_name("aws_sdk_opensearchserverless::config::ConfigOverrideRuntimePlugin")
                .freeze(),
            components,
        }
    }
        ...
        if input.get_origin("endpoint_url").is_client_config() {
            ...
            builder.set_endpoint_url(
                input
                    .service_config()
                    .and_then(|conf| {
                        conf.load_config(service_config_key("OpenSearchServerless", "AWS_ENDPOINT_URL", "endpoint_url"))
...
pub(crate) fn base_client_runtime_plugins(mut config: crate::Config) -> ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugins {
    ...
    let default_retry_partition = "opensearchserverless";
    ...
    let scope = "aws-sdk-opensearchserverless";
