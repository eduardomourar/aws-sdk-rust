...
impl CreatePrivateDnsNamespace {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::create_private_dns_namespace::CreatePrivateDnsNamespaceError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::create_private_dns_namespace::CreatePrivateDnsNamespaceOutput>()
    ...
    > {
        ...
        .instrument(::tracing::debug_span!(
            ...
            "rpc.method" = "CreatePrivateDnsNamespace",
    ...
    pub(crate) fn operation_runtime_plugins(
        ...
        runtime_plugins = runtime_plugins.with_operation_plugin(crate::client_idempotency_token::IdempotencyTokenRuntimePlugin::new(
            |token_provider, input| {
                let input: &mut crate::operation::create_private_dns_namespace::CreatePrivateDnsNamespaceInput =
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for CreatePrivateDnsNamespace {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        let mut cfg = ::aws_smithy_types::config_bag::Layer::new("CreatePrivateDnsNamespace");

        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            CreatePrivateDnsNamespaceRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            CreatePrivateDnsNamespaceResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("CreatePrivateDnsNamespace")
                .build()
    ...
    fn runtime_components(
        ...
        #[allow(unused_mut)]
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("CreatePrivateDnsNamespace")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                ::aws_smithy_runtime::client::stalled_stream_protection::StalledStreamProtectionInterceptor::default(),
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                CreatePrivateDnsNamespaceEndpointParamsInterceptor,
            ))
...
#[derive(Debug)]
struct CreatePrivateDnsNamespaceResponseDeserializer;
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for CreatePrivateDnsNamespaceResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            ...
            crate::protocol_serde::shape_create_private_dns_namespace::de_create_private_dns_namespace_http_response(status, headers, body)
        };
        crate::protocol_serde::type_erase_result(parse_result)
    }
}
#[derive(Debug)]
struct CreatePrivateDnsNamespaceRequestSerializer;
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for CreatePrivateDnsNamespaceRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::create_private_dns_namespace::CreatePrivateDnsNamespaceInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::create_private_dns_namespace::CreatePrivateDnsNamespaceInput,
        ...
        let body = ::aws_smithy_types::body::SdkBody::from(
            crate::protocol_serde::shape_create_private_dns_namespace::ser_create_private_dns_namespace_input(&input)?,
        );
...
#[derive(Debug)]
struct CreatePrivateDnsNamespaceEndpointParamsInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for CreatePrivateDnsNamespaceEndpointParamsInterceptor {
    ...
    fn read_before_execution(
        ...
        let _input = context
            .input()
            .downcast_ref::<CreatePrivateDnsNamespaceInput>()
            .ok_or("failed to downcast to CreatePrivateDnsNamespaceInput")?;
...
pub enum CreatePrivateDnsNamespaceError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-CreatePrivateDnsNamespaceError) for what information is available for the error.")]
...
impl CreatePrivateDnsNamespaceError {
    ...
    /// Creates the `CreatePrivateDnsNamespaceError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for CreatePrivateDnsNamespaceError {
...
impl ::aws_types::request_id::RequestId for crate::operation::create_private_dns_namespace::CreatePrivateDnsNamespaceError {
