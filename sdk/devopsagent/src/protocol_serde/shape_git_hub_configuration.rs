...
pub fn ser_git_hub_configuration(
    ...
    {
        object.key("repoName").string(input.repo_name.as_str());
    }
    {
        object.key("repoId").string(input.repo_id.as_str());
    }
    {
        object.key("owner").string(input.owner.as_str());
    }
    {
        object.key("ownerType").string(input.owner_type.as_str());
    }
