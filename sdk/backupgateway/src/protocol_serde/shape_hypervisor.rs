...
pub(crate) fn de_hypervisor(
    decoder: &mut ::aws_smithy_cbor::Decoder,
    depth: u32,
) -> ::std::result::Result<crate::types::Hypervisor, ::aws_smithy_cbor::decode::DeserializeError> {
    if depth >= 128u32 {
    ...
    fn pair(
        mut builder: crate::types::builders::HypervisorBuilder,
        decoder: &mut ::aws_smithy_cbor::Decoder,
        depth: u32,
    ) -> ::std::result::Result<crate::types::builders::HypervisorBuilder, ::aws_smithy_cbor::decode::DeserializeError> {
    ...
    let mut builder = crate::types::builders::HypervisorBuilder::default();
