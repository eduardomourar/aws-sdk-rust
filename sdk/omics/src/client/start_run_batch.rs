...
impl super::Client {
    ...
    ///   - [`tags(impl Into<String>, impl Into<String>)`](crate::operation::start_run_batch::builders::StartRunBatchFluentBuilder::tags) / [`set_tags(Option<HashMap::<String, String>>)`](crate::operation::start_run_batch::builders::StartRunBatchFluentBuilder::set_tags):<br>required: **false**<br><p>Amazon Web Services tags to associate with the batch resource. These tags are not inherited by individual runs. To tag individual runs, use <code>defaultRunSetting.runTags</code>.</p><br>
    ...
    ///   - [`tags(Option<HashMap::<String, String>>)`](crate::operation::start_run_batch::StartRunBatchOutput::tags): <p>Amazon Web Services tags associated with the run batch.</p>
