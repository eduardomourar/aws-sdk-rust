...
impl super::Client {
    ...
    ///   - [`vended_metrics(Option<VendedMetricsSettings>)`](crate::operation::get_account_settings::GetAccountSettingsOutput::vended_metrics): <p>The configuration for vended metrics in the account.</p>
