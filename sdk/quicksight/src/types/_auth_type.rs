...
///     AuthType::ThreeLeggedOauth => { /* ... */ },
///     AuthType::TwoLeggedOauth => { /* ... */ },
...
impl ::std::convert::From<&str> for AuthType {
    fn from(s: &str) -> Self {
        match s {
            ...
            "THREE_LEGGED_OAUTH" => AuthType::ThreeLeggedOauth,
            "TWO_LEGGED_OAUTH" => AuthType::TwoLeggedOauth,
...
impl AuthType {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            ...
            AuthType::ThreeLeggedOauth => "THREE_LEGGED_OAUTH",
            AuthType::TwoLeggedOauth => "TWO_LEGGED_OAUTH",
            AuthType::Unknown(value) => value.as_str(),
        }
    }
    /// Returns all the `&str` representations of the enum members.
    pub const fn values() -> &'static [&'static str] {
        &["SERVICE_ACCOUNT", "THREE_LEGGED_OAUTH", "TWO_LEGGED_OAUTH"]
    }
}
...
impl ::std::fmt::Display for AuthType {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            ...
            AuthType::ThreeLeggedOauth => write!(f, "THREE_LEGGED_OAUTH"),
            AuthType::TwoLeggedOauth => write!(f, "TWO_LEGGED_OAUTH"),
