...
/// match discoverytype {
///     DiscoveryType::Managed => { /* ... */ },
///     DiscoveryType::SelfHosted => { /* ... */ },
...
impl ::std::convert::From<&str> for DiscoveryType {
    fn from(s: &str) -> Self {
        match s {
            "Managed" => DiscoveryType::Managed,
            "SelfHosted" => DiscoveryType::SelfHosted,
...
impl DiscoveryType {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            DiscoveryType::Managed => "Managed",
            DiscoveryType::SelfHosted => "SelfHosted",
...
impl ::std::fmt::Display for DiscoveryType {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match self {
            DiscoveryType::Managed => write!(f, "Managed"),
            DiscoveryType::SelfHosted => write!(f, "SelfHosted"),
