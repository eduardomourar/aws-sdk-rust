...
impl GetMetricDataV2FluentBuilder {
    ...
    /// </dt>
    /// <dd>
    /// <p>This metric is available only for outbound campaigns using the email, WhatsApp, and web notification delivery modes.</p>
    /// <p>Unit: Count</p>
    /// <p>Valid metric filter key: CAMPAIGN_INTERACTION_EVENT_TYPE</p>
    /// <p>Valid groupings and filters: Browser Name, Campaign, Channel, contact/segmentAttributes/connect:Subtype, Device Model, Device Type, Web Notification Type</p>
    ...
    /// <p>Valid groupings and filters: Agent, Answering Machine Detection Status, Browser Name, Campaign, Campaign Delivery EventType, Channel, contact/segmentAttributes/connect:Subtype, Device Model, Device Type, Disconnect Reason, Queue, Routing Profile, Web Notification Type</p>
    ...
    /// <p>Campaign Delivery EventType filter and grouping are only available for SMS, Email, WhatsApp, and web notification campaign delivery modes. Agent, Queue, Routing Profile, Answering Machine Detection Status and Disconnect Reason are only available for agent assisted voice and automated voice delivery modes.</p>
    /// </note>
    /// </dd>
    /// <dt>
    ...
    /// <p>Unit: Percent</p>
    /// <p>Valid metric filter key: <code>ANSWERING_MACHINE_DETECTION_STATUS</code>, <code>CAMPAIGN_DELIVERY_EVENT_TYPE</code>, <code>DISCONNECT_REASON</code></p>
    /// <p>Valid groupings and filters: Agent, Answering Machine Detection Status, Browser Name, Campaign, Channel, contact/segmentAttributes/connect:Subtype, Device Model, Device Type, Disconnect Reason, Queue, Routing Profile, Web Notification Type</p>
    ...
    /// <p>Campaign Delivery Event Type filter and grouping are only available for SMS, Email, WhatsApp, and web notification campaign delivery modes. Agent, Queue, Routing Profile, Answering Machine Detection Status and Disconnect Reason are only available for agent assisted voice and automated voice delivery modes.</p>
    /// </note>
    /// </dd>
    /// <dt>
