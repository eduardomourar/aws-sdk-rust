...
pub fn de_search_http_error(
    ...
    Err(match error_code {
        ...
        "InternalServiceException" => crate::operation::search::SearchError::InternalServiceException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
        ...
        "InvalidInputException" => crate::operation::search::SearchError::InvalidInputException({
            #[allow(unused_mut)]
            let mut tmp = {
                #[allow(unused_mut)]
