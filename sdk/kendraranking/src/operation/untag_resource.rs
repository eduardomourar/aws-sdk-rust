...
impl UntagResource {
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("Kendra Ranking", "UntagResource", input, runtime_plugins, stop_point)
    ...
    fn serialize_input(
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                ...
                ::std::write!(output, "/service/AWSKendraRerankingFrontendService/operation/UntagResource").expect("formatting should succeed");
                ::std::result::Result::Ok(())
            }
