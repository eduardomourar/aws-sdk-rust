...
pub(crate) fn de_schema_type_properties<'a, I>(
    tokens: &mut ::std::iter::Peekable<I>,
    _value: &'a [u8],
    depth: u32,
) -> ::std::result::Result<Option<crate::types::SchemaTypeProperties>, ::aws_smithy_json::deserialize::error::DeserializeError>
where
