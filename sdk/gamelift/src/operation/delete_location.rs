...
impl DeleteLocation {
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("GameLift", "DeleteLocation", input, runtime_plugins, stop_point)
    ...
    fn serialize_input(
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                ...
                ::std::write!(output, "/service/GameLift/operation/DeleteLocation").expect("formatting should succeed");
                ::std::result::Result::Ok(())
            }
...
impl DeleteLocationError {
    ...
    /// Returns `true` if the error kind is `DeleteLocationError::UnsupportedRegionException`.
