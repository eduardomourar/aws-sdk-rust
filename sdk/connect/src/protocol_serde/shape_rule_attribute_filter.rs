...
pub fn ser_rule_attribute_filter(
    object: &mut ::aws_smithy_json::serialize::JsonObjectWriter,
    input: &crate::types::RuleAttributeFilter,
        ...
        for item_3 in var_1 {
            {
                ...
                crate::protocol_serde::shape_rule_attribute_and_condition::ser_rule_attribute_and_condition(&mut object_4, item_3)?;
                object_4.finish();
            }
        }
        array_2.finish();
    ...
    if let Some(var_5) = &input.and_condition {
        ...
        crate::protocol_serde::shape_rule_attribute_and_condition::ser_rule_attribute_and_condition(&mut object_6, var_5)?;
        object_6.finish();
    }
