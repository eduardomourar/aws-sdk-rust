                ...
                Some(::aws_smithy_json::deserialize::Token::ObjectKey { key, .. }) => {
                    ...
                    variant = match key.as_ref() {
                        "Analysis" => Some(crate::types::IngressBooleanToEvaluate::Analysis(
                            crate::protocol_serde::shape_ingress_analysis::de_ingress_analysis(tokens, _value, depth + 1)?.ok_or_else(|| {
                        ...
                        "IsInAddressList" => Some(crate::types::IngressBooleanToEvaluate::IsInAddressList(
                            crate::protocol_serde::shape_ingress_is_in_address_list::de_ingress_is_in_address_list(tokens, _value, depth + 1)?
                                .ok_or_else(|| {
