...
pub(crate) fn de_stack_error(
    decoder: &mut ::aws_smithy_cbor::Decoder,
    depth: u32,
) -> ::std::result::Result<crate::types::StackError, ::aws_smithy_cbor::decode::DeserializeError> {
    if depth >= 128u32 {
    ...
    fn pair(
        mut builder: crate::types::builders::StackErrorBuilder,
        decoder: &mut ::aws_smithy_cbor::Decoder,
        depth: u32,
    ) -> ::std::result::Result<crate::types::builders::StackErrorBuilder, ::aws_smithy_cbor::decode::DeserializeError> {
        builder =
    ...
    let mut builder = crate::types::builders::StackErrorBuilder::default();
