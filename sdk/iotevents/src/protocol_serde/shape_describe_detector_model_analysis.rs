...
> {
    ...
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body)
        .map_err(crate::operation::describe_detector_model_analysis::DescribeDetectorModelAnalysisError::unhandled)?;
    ...
    Err(match error_code {
        "InternalFailureException" => {
            crate::operation::describe_detector_model_analysis::DescribeDetectorModelAnalysisError::InternalFailureException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "InvalidRequestException" => {
            crate::operation::describe_detector_model_analysis::DescribeDetectorModelAnalysisError::InvalidRequestException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "ResourceNotFoundException" => {
            crate::operation::describe_detector_model_analysis::DescribeDetectorModelAnalysisError::ResourceNotFoundException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
        ...
        "ServiceUnavailableException" => {
            crate::operation::describe_detector_model_analysis::DescribeDetectorModelAnalysisError::ServiceUnavailableException({
                #[allow(unused_mut)]
                let mut tmp = {
                    #[allow(unused_mut)]
...
> {
    Ok({
        ...
        output = crate::protocol_serde::shape_describe_detector_model_analysis::de_describe_detector_model_analysis(_response_body, output)
            .map_err(crate::operation::describe_detector_model_analysis::DescribeDetectorModelAnalysisError::unhandled)?;
