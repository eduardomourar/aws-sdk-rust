...
impl super::Client {
    ...
    ///   - [`identifier(impl Into<String>)`](crate::operation::disassociate_glossary_terms::builders::DisassociateGlossaryTermsFluentBuilder::identifier) / [`set_identifier(Option<String>)`](crate::operation::disassociate_glossary_terms::builders::DisassociateGlossaryTermsFluentBuilder::set_identifier):<br>required: **true**<br><p>The unique identifier of the asset to disassociate glossary terms from.</p><br>
    ...
    ///   - [`identifier(Option<String>)`](crate::operation::disassociate_glossary_terms::DisassociateGlossaryTermsOutput::identifier): <p>The unique identifier of the asset.</p>
