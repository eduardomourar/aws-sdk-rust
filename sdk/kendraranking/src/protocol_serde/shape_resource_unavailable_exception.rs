...
pub(crate) fn de_resource_unavailable_exception_cbor_err(
    value: &[u8],
    mut builder: crate::types::error::builders::ResourceUnavailableExceptionBuilder,
) -> ::std::result::Result<crate::types::error::builders::ResourceUnavailableExceptionBuilder, ::aws_smithy_cbor::decode::DeserializeError> {
