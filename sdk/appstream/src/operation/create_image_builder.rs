...
impl CreateImageBuilder {
    ...
    > {
        ...
        >| {
            err.map_service_error(|err| {
                err.downcast::<crate::operation::create_image_builder::CreateImageBuilderError>()
        ...
        ::std::result::Result::Ok(
            output
                .downcast::<crate::operation::create_image_builder::CreateImageBuilderOutput>()
    ...
    > {
        ...
        ::aws_smithy_runtime::client::orchestrator::invoke_with_stop_point("AppStream", "CreateImageBuilder", input, runtime_plugins, stop_point)
            // Create a parent span for the entire operation. Includes a random, internal-only,
            // seven-digit ID for the operation orchestration so that it can be correlated in the logs.
            .instrument(::tracing::debug_span!(
                "AppStream.CreateImageBuilder",
                "rpc.service" = "AppStream",
                "rpc.method" = "CreateImageBuilder",
...
impl ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugin for CreateImageBuilder {
    fn config(&self) -> ::std::option::Option<::aws_smithy_types::config_bag::FrozenLayer> {
        let mut cfg = ::aws_smithy_types::config_bag::Layer::new("CreateImageBuilder");

        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedRequestSerializer::new(
            CreateImageBuilderRequestSerializer,
        ));
        cfg.store_put(::aws_smithy_runtime_api::client::ser_de::SharedResponseDeserializer::new(
            CreateImageBuilderResponseDeserializer,
        ));

        cfg.store_put(::aws_smithy_runtime_api::client::auth::AuthSchemeOptionResolverParams::new(
            crate::config::auth::Params::builder()
                .operation_name("CreateImageBuilder")
                .build()
    ...
    fn runtime_components(
        ...
        #[allow(unused_mut)]
        let mut rcb = ::aws_smithy_runtime_api::client::runtime_components::RuntimeComponentsBuilder::new("CreateImageBuilder")
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                ::aws_smithy_runtime::client::stalled_stream_protection::StalledStreamProtectionInterceptor::default(),
            ))
            .with_interceptor(::aws_smithy_runtime_api::client::interceptors::SharedInterceptor::permanent(
                CreateImageBuilderEndpointParamsInterceptor,
            ))
...
#[derive(Debug)]
struct CreateImageBuilderResponseDeserializer;
impl ::aws_smithy_runtime_api::client::ser_de::DeserializeResponse for CreateImageBuilderResponseDeserializer {
    fn deserialize_nonstreaming_with_config(
        ...
        let parse_result = if !success && status != 200 || force_error {
            ...
            crate::protocol_serde::shape_create_image_builder::de_create_image_builder_http_response(status, headers, body)
        };
        crate::protocol_serde::type_erase_result(parse_result)
    }
}
#[derive(Debug)]
struct CreateImageBuilderRequestSerializer;
impl ::aws_smithy_runtime_api::client::ser_de::SerializeRequest for CreateImageBuilderRequestSerializer {
    ...
    fn serialize_input(
        ...
        let input = input
            .downcast::<crate::operation::create_image_builder::CreateImageBuilderInput>()
            .expect("correct type");
        ...
        let mut request_builder = {
            ...
            fn uri_base(
                _input: &crate::operation::create_image_builder::CreateImageBuilderInput,
                output: &mut ::std::string::String,
            ) -> ::std::result::Result<(), ::aws_smithy_types::error::operation::BuildError> {
                use ::std::fmt::Write as _;
                ::std::write!(output, "/service/PhotonAdminProxyService/operation/CreateImageBuilder").expect("formatting should succeed");
                ::std::result::Result::Ok(())
            }
        ...
        let body =
            ::aws_smithy_types::body::SdkBody::from(crate::protocol_serde::shape_create_image_builder::ser_create_image_builder_input(&input)?);
...
#[derive(Debug)]
struct CreateImageBuilderEndpointParamsInterceptor;

#[::aws_smithy_runtime_api::client::interceptors::dyn_dispatch_hint]
impl ::aws_smithy_runtime_api::client::interceptors::Intercept for CreateImageBuilderEndpointParamsInterceptor {
    ...
    fn read_before_execution(
        ...
        let _input = context
            .input()
            .downcast_ref::<CreateImageBuilderInput>()
            .ok_or("failed to downcast to CreateImageBuilderInput")?;
...
pub enum CreateImageBuilderError {
    ...
    &nbsp;&nbsp;&nbsp;`err if err.code() == Some(\"SpecificExceptionCode\") => { /* handle the error */ }`
     \
    See [`ProvideErrorMetadata`](#impl-ProvideErrorMetadata-for-CreateImageBuilderError) for what information is available for the error.")]
...
impl CreateImageBuilderError {
    ...
    /// Creates the `CreateImageBuilderError::Unhandled` variant from an [`ErrorMetadata`](::aws_smithy_types::error::ErrorMetadata).
...
impl ::aws_smithy_runtime_api::client::result::CreateUnhandledError for CreateImageBuilderError {
...
impl ::aws_types::request_id::RequestId for crate::operation::create_image_builder::CreateImageBuilderError {
