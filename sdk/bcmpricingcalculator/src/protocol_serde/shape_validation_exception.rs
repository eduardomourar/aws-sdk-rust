...
pub(crate) fn de_validation_exception_cbor_err(
    ...
    fn pair(
        ...
        builder = match decoder.str()?.as_ref() {
            ...
            "reason" => ::aws_smithy_cbor::decode::set_optional(builder, decoder, |builder, decoder| {
                Ok(builder.set_reason(Some(decoder.string().map(|s| crate::types::ValidationExceptionReason::from(s.as_ref()))?)))
            })?,
