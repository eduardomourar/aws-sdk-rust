...
pub(crate) fn de_invalid_role_exception_cbor_err(
    value: &[u8],
    mut builder: crate::types::error::builders::InvalidRoleExceptionBuilder,
) -> ::std::result::Result<crate::types::error::builders::InvalidRoleExceptionBuilder, ::aws_smithy_cbor::decode::DeserializeError> {
